    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('colegio', models.ForeignKey(db_column='id_colegio', on_delete=django.db.models.deletion.DO_NOTHING, related_name='caja_chica', to='register.Sucursal')),
                ('usuario_creacion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personal', models.ForeignKey(db_column='id_personal_colegio', on_delete=django.db.models.deletion.DO_NOTHING, related_name='pagos', to='register.PersonalSucursal')),
                ('proveedor', models.ForeignKey(db_column='id_proveedor_colegio', on_delete=django.db.models.deletion.DO_NOTHING, to='register.ProveedorSucursal')),
                ('usuario_creacion',
                 models.CharField(blank=True, max_length=10, null=True, verbose_name='Usuario_Creacion')),
                ('usuario_modificacion',
                 models.CharField(blank=True, max_length=10, null=True, verbose_name='Usuario_Modificacion')),
